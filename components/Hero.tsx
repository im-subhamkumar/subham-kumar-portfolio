...
const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex flex-col justify-center items-center pt-20 pb-10 sm:pt-24 sm:pb-12 relative overflow-visible">
      ...
      <div className="max-w-7xl mx-auto px-4 w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4 items-center">
            ...
            <motion.a
              whileHover={{ scale: 1.05, y: -4, boxShadow: "0 15px 20px -5px rgb(16 185 129 / 0.4)" }}
              whileTap={{ scale: 0.98 }}
              href="https://drive.google.com/file/d/1CZuASGh4igu_EEU8ISU0Sr30WPoPO1q7/view?usp=drive_link"
              className="px-6 py-3 sm:px-8 sm:py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-black uppercase tracking-wider text-[10px] sm:text-xs rounded-2xl shadow-xl shadow-emerald-500/30 transition-all flex items-center gap-2"
              target="_blank"
